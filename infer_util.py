...
def score_sequence(session, global_step_increment, summary_op, summary_writer,
  ...
  save_dict = {
      ...
      'note_precision': sequence_note_precision,
      'note_recall': sequence_note_recall,
      'note_f1': sequence_note_f1,
      'note_precision_with_offsets': sequence_note_precision_with_offsets,
      'note_recall_with_offsets': sequence_note_recall_with_offsets,
      'metric_note_f1_with_offsets': sequence_note_f1_with_offsets}

  return sequence_label, save_dict
